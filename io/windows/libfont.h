...
void set_fontstring(PIXEL_UNIT *buffer, int MAX_X, int MAX_Y, int x, int y, int bound_x, int bound_y, const char * str, PIXEL_UNIT text_color, PIXEL_UNIT backColor, bool print_caret=false);
